...
TEST(PooledNameTest, RendersThroughItsOwnPool)
{
	TwinePool pool;
...
TEST(PooledNameTest, DivergedPoolsRenderIndependently)
{
	TwinePool pool_a;
	TwinePool pool_b;
...
TEST(PooledNameTest, PoollessNameStillRendersConstids)
{
...
TEST(PooledNameTest, PoollessNameIsUsableAsALookupKey)
{
	TwinePool pool;
