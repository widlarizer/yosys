...
TEST(TwineHashTest, ContentHashIgnoresFragmentation)
{
	TwinePool pool;
...
TEST(TwineHashTest, ContentHashStableAcrossEverySplitPoint)
{
...
TEST(TwineHashTest, DistinctContentHashesDiffer)
{
	TwinePool twines;
...
TEST(TwineHashTest, BenchmarkInternAndSearch)
{
