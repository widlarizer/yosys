...
struct AbstractCellEdgesDatabase
{
	...
	virtual void add_edge(RTLIL::Cell *cell, IdString from_port, int from_bit, IdString to_port, int to_bit, int delay) = 0;
...
struct FwdCellEdgesDatabase : AbstractCellEdgesDatabase
{
	...
	void add_edge(RTLIL::Cell *cell, IdString from_port, int from_bit, IdString to_port, int to_bit, int) override {
